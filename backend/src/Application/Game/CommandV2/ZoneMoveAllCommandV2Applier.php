...
final class ZoneMoveAllCommandV2Applier implements GameCommandV2ApplierInterface
{
    public function supports(string $type): bool
    {
        return $type === 'zone.move_all';
    }
    ...
    public function apply(array &$snapshot, array $payload, User $actor, GameCommandHandler $helper): ?GameCommandV2Result
    {
        ...
        $data = $helper->v2MoveCommandData($snapshot, $payload, 'all');
