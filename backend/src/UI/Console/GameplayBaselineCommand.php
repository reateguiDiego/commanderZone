...
final class GameplayBaselineCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $selectedScenarios = $this->selectedScenarios($input->getOption('scenario'));
        ...
        $this->renderTable($output, $scenarioReports, $iterations, $outputPath, $rawOutputPath);
     ...
     */
    private function selectedScenarios(array $selectedScenarioOptions): array
    {
     ...
     * @param list<array<string,mixed>> $metrics
     */
    private function percentile(array $metrics, string $key, int $percentile): float
    {
        if ($metrics === []) {
            return 0.0;
        }
     ...
     */
    private function renderTable(OutputInterface $output, array $scenarioReports, int $iterations, string $outputPath, string $rawOutputPath): void
    {
