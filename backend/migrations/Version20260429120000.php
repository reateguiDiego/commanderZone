...
final class Version20260429120000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE friendship (id VARCHAR(36) NOT NULL, requester_id VARCHAR(36) NOT NULL, recipient_id VARCHAR(36) NOT NULL, status VARCHAR(24) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX idx_friendship_requester ON friendship (requester_id)');
        $this->addSql('CREATE INDEX idx_friendship_recipient ON friendship (recipient_id)');
        $this->addSql('CREATE UNIQUE INDEX uniq_friendship_pair ON friendship (LEAST(requester_id, recipient_id), GREATEST(requester_id, recipient_id))');
        ...
        $this->addSql('ALTER TABLE friendship ADD CONSTRAINT FK_5EBC0C4DED442CF4 FOREIGN KEY (requester_id) REFERENCES app_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE friendship ADD CONSTRAINT FK_5EBC0C4DE92F8F78 FOREIGN KEY (recipient_id) REFERENCES app_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE friendship DROP CONSTRAINT FK_5EBC0C4DED442CF4');
        $this->addSql('ALTER TABLE friendship DROP CONSTRAINT FK_5EBC0C4DE92F8F78');
