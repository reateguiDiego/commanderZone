...
final class Version20260429180000 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE game_event ADD client_action_id VARCHAR(120) DEFAULT NULL');
        $this->addSql('CREATE UNIQUE INDEX uniq_game_event_client_action ON game_event (game_id, client_action_id)');
    }
