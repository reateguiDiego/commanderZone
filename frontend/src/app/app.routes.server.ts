...
export const serverRoutes: ServerRoute[] = [
  ...
  { path: 'community/decks', renderMode: RenderMode.Prerender },
  { path: 'community/decks/:slug/analysis', renderMode: RenderMode.Client },
  ...
  { path: 'decks/:slug/analysis', renderMode: RenderMode.Client },
  { path: 'decks/:slug', renderMode: RenderMode.Client },
