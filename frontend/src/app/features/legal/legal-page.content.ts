...
export const LEGAL_PAGE_CONTENT = {
  privacy: {
    en: legalPage('privacy', 'en', 'Privacy Policy | CommanderZone', 'Privacy Policy', 'How CommanderZone handles account data, cookies, deck data, room metadata, technical logs and advertising consent.', [
      ...
      section('Cookies and ads', 'CommanderZone uses essential cookies and functional preferences. It does not use analytics. When an active publisher id is configured, Google AdSense may be loaded to request non-personalized ads by default. Personalized ads are requested only after personalized advertising consent. Some regions may require a certified CMP or additional consent controls before serving ads.'),
    ...
    es: legalPage('privacy', 'es', 'Política de privacidad | CommanderZone', 'Política de privacidad', 'Cómo CommanderZone trata datos de cuenta, cookies, mazos, metadatos de sala, registros técnicos y consentimiento publicitario.', [
      ...
      section('Cookies y publicidad', 'CommanderZone usa cookies esenciales y preferencias funcionales. No usa analítica ni trata la publicidad como consentida por defecto. Si hay un publisher id activo configurado, Google AdSense puede cargarse para pedir anuncios no personalizados por defecto. Los anuncios personalizados solo se piden tras consentimiento de publicidad personalizada. Algunas regiones pueden requerir una CMP certificada o controles adicionales antes de servir anuncios.'),
    ...
    de: legalPage('privacy', 'de', 'Datenschutzerklärung | CommanderZone', 'Datenschutzerklärung', 'Wie CommanderZone Kontodaten, Cookies, Deckdaten, Raum-Metadaten, technische Logs und Werbeeinwilligung verarbeitet.', [
      ...
      section('Cookies und Werbung', 'CommanderZone verwendet essenzielle Cookies und funktionale Einstellungen. Es verwendet keine Analyse. Mit aktiver Publisher-ID kann Google AdSense geladen werden, um standardmäßig nicht personalisierte Anzeigen anzufragen. Personalisierte Anzeigen werden nur nach Einwilligung in personalisierte Werbung angefragt. Einige Regionen können eine zertifizierte CMP oder zusätzliche Einwilligungskontrollen erfordern.'),
    ...
    fr: legalPage('privacy', 'fr', 'Politique de confidentialité | CommanderZone', 'Politique de confidentialité', 'Comment CommanderZone traite les données de compte, cookies, decks, métadonnées de salon, journaux techniques et consentement publicitaire.', [
      ...
      section('Cookies et publicité', 'CommanderZone utilise des cookies essentiels et des préférences fonctionnelles. Aucune analyse n’est utilisée. Avec un publisher id actif, Google AdSense peut se charger pour demander des annonces non personnalisées par défaut. Les annonces personnalisées sont demandées uniquement après consentement à la publicité personnalisée. Certaines régions peuvent exiger une CMP certifiée ou des contrôles de consentement supplémentaires.'),
    ...
    pt: legalPage('privacy', 'pt', 'Política de privacidade | CommanderZone', 'Política de privacidade', 'Como o CommanderZone processa dados de conta, cookies, decks, metadados de sala, logs técnicos e consentimento de publicidade.', [
      ...
      section('Cookies e publicidade', 'CommanderZone usa cookies essenciais e preferências funcionais. Não usa análise. Com publisher id ativo configurado, Google AdSense pode carregar para solicitar anúncios não personalizados por padrão. Anúncios personalizados são solicitados somente após consentimento de publicidade personalizada. Algumas regiões podem exigir CMP certificada ou controles adicionais de consentimento.'),
    ...
    it: legalPage('privacy', 'it', 'Informativa sulla privacy | CommanderZone', 'Informativa sulla privacy', 'Come CommanderZone tratta dati account, cookie, mazzi, metadati delle stanze, log tecnici e consenso pubblicitario.', [
      ...
      section('Cookie e pubblicità', 'CommanderZone usa cookie essenziali e preferenze funzionali. Non usa analisi. Con publisher id attivo, Google AdSense può caricarsi per richiedere annunci non personalizzati per impostazione predefinita. Gli annunci personalizzati sono richiesti solo dopo il consenso alla pubblicità personalizzata. Alcune regioni possono richiedere una CMP certificata o controlli di consenso aggiuntivi.'),
...
function cookiePage(locale: SeoLocaleCode, title: string, h1: string): LegalPageContent {
  const descriptions = {
    en: 'How CommanderZone uses essential cookies, functional preferences and advertising consent controls.',
    es: 'Cómo CommanderZone usa cookies esenciales, preferencias funcionales y controles de consentimiento publicitario.',
    de: 'Wie CommanderZone essenzielle Cookies, funktionale Einstellungen und Werbeeinwilligung nutzt.',
    fr: 'Comment CommanderZone utilise les cookies essentiels, les préférences fonctionnelles et les contrôles de consentement publicitaire.',
    pt: 'Como o CommanderZone usa cookies essenciais, preferências funcionais e controles de consentimento de publicidade.',
    it: 'Come CommanderZone usa cookie essenziali, preferenze funzionali e controlli di consenso pubblicitario.',
  } as const satisfies Record<SeoLocaleCode, string>;
  const copy = {
    en: [
      ...
      section('Analytics and ads', 'CommanderZone does not use analytics cookies. Google AdSense may request non-personalized ads by default when an active publisher id is configured. Personalized ads are requested only after personalized advertising consent.'),
    ...
    es: [
      ...
      section('Analítica y publicidad', 'CommanderZone no usa cookies de analítica ni trata la publicidad como consentida por defecto. Google AdSense puede pedir anuncios no personalizados por defecto si hay un publisher id activo configurado. Los anuncios personalizados solo se piden tras consentimiento de publicidad personalizada.'),
    ...
    de: [
      ...
      section('Analyse und Werbung', 'CommanderZone verwendet keine Analyse-Cookies. Google AdSense kann mit aktiver Publisher-ID standardmäßig nicht personalisierte Anzeigen anfragen. Personalisierte Anzeigen werden nur nach Einwilligung in personalisierte Werbung angefragt.'),
    ...
    fr: [
      ...
      section('Analyse et publicité', 'CommanderZone n’utilise pas de cookies d’analyse. Google AdSense peut demander des annonces non personnalisées par défaut avec un publisher id actif. Les annonces personnalisées sont demandées uniquement après consentement à la publicité personnalisée.'),
    ...
    pt: [
      ...
      section('Análise e publicidade', 'CommanderZone não usa cookies de análise. Google AdSense pode solicitar anúncios não personalizados por padrão quando houver publisher id ativo configurado. Anúncios personalizados são solicitados somente após consentimento de publicidade personalizada.'),
    ...
    it: [
      ...
      section('Analisi e pubblicità', 'CommanderZone non usa cookie di analisi. Google AdSense può richiedere annunci non personalizzati per impostazione predefinita con publisher id attivo. Gli annunci personalizzati sono richiesti solo dopo il consenso alla pubblicità personalizzata.'),
