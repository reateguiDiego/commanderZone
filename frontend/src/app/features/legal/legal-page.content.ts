...
export const LEGAL_PAGE_CONTENT = {
  privacy: {
    ...
    es: legalPage('privacy', 'es', 'Política de privacidad | CommanderZone', 'Política de privacidad', 'Cómo CommanderZone trata datos de cuenta, cookies, mazos, metadatos de sala, registros técnicos y consentimiento publicitario.', [
      ...
      section('Cookies y publicidad', 'CommanderZone usa cookies esenciales y preferencias funcionales. No usa analítica. Si hay un publisher id activo configurado, Google AdSense puede cargarse para pedir anuncios no personalizados por defecto. Los anuncios personalizados solo se piden tras consentimiento de publicidad personalizada. Algunas regiones pueden requerir una CMP certificada o controles adicionales antes de servir anuncios.'),
...
function cookiePage(locale: SeoLocaleCode, title: string, h1: string): LegalPageContent {
  ...
  const copy = {
    ...
    es: [
      ...
      section('Analítica y publicidad', 'CommanderZone no usa cookies de analítica. Google AdSense puede pedir anuncios no personalizados por defecto si hay un publisher id activo configurado. Los anuncios personalizados solo se piden tras consentimiento de publicidad personalizada.'),
