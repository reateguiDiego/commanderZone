...
const PUBLIC_CHROME_COPY = {
  en: {
    ...
    cookieBanner: {
      ...
      adsCookies: 'Personalized ads',
      adsDescription: 'Allows personalized Google AdSense ads. If disabled, ads are requested as non-personalized when a publisher id is active.',
    },
    disclaimer: {
      heading: 'Disclaimer',
  ...
  es: {
    ...
    cookieBanner: {
      ...
      adsCookies: 'Anuncios personalizados',
      adsDescription: 'Permite anuncios personalizados de Google AdSense. Si se desactiva, se piden anuncios no personalizados cuando hay un publisher id activo.',
    },
    disclaimer: {
      heading: 'Aviso legal',
  ...
  de: {
    ...
    cookieBanner: {
      ...
      adsCookies: 'Personalisierte Werbung',
      adsDescription: 'Erlaubt personalisierte Google AdSense Werbung. Wenn deaktiviert, werden mit aktiver Publisher-ID nicht personalisierte Anzeigen angefragt.',
    },
    disclaimer: {
      heading: 'Hinweis',
  ...
  fr: {
    ...
    cookieBanner: {
      ...
      adsCookies: 'Publicité personnalisée',
      adsDescription: 'Autorise les annonces Google AdSense personnalisées. Si désactivé, les annonces sont demandées sans personnalisation avec un publisher id actif.',
    },
    disclaimer: {
  ...
  pt: {
    ...
    cookieBanner: {
      ...
      adsCookies: 'Anúncios personalizados',
      adsDescription: 'Permite anúncios personalizados do Google AdSense. Se desativado, anúncios não personalizados são solicitados quando houver publisher id ativo.',
    },
    disclaimer: {
      heading: 'Aviso legal',
  ...
  it: {
    ...
    cookieBanner: {
      ...
      adsCookies: 'Annunci personalizzati',
      adsDescription: 'Consente annunci Google AdSense personalizzati. Se disattivato, vengono richiesti annunci non personalizzati con publisher id attivo.',
    },
    disclaimer: {
