...
- Name: decks-valid-helper.spec.ts >> createValidCommanderDeckFromDatabase returns a backend-valid Commander deck
- Location: e2e\decks-valid-helper.spec.ts:7:5
