...
- Name: game-concede-turn-guard.multiplayer.spec.ts >> active player concede blocks local pass-turn command and keeps table stable
- Location: e2e\game-concede-turn-guard.multiplayer.spec.ts:11:5
