...
- Name: rooms-private-invite.multiplayer.spec.ts >> private room invite flow: accepted friend joins, owner starts, both open game
- Location: e2e\rooms-private-invite.multiplayer.spec.ts:8:5
