...
- Name: rooms-public-negatives.spec.ts >> public room negatives: no deck join denied, invalid deck join denied, non-owner start denied, valid join allowed
- Location: e2e\rooms-public-negatives.spec.ts:7:5
