...
- Name: game-move-hand-battlefield.multiplayer.spec.ts >> player can move a hand card to battlefield with manual fallback and sync to opponent
- Location: e2e\game-move-hand-battlefield.multiplayer.spec.ts:8:5
