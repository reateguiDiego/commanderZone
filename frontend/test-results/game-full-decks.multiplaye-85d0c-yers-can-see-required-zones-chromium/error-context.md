...
- Name: game-full-decks.multiplayer.spec.ts >> game starts with two full decks and both players can see required zones
- Location: e2e\game-full-decks.multiplayer.spec.ts:8:5
