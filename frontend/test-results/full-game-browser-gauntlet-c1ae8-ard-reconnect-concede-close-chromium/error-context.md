...
- Name: full-game-browser-gauntlet.spec.ts >> full game browser gauntlet: multiplayer open, life sync, chat sync, move card, reconnect, concede, close
- Location: e2e\full-game-browser-gauntlet.spec.ts:11:5
