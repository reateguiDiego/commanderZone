...
- Name: game-draw-library.multiplayer.spec.ts >> drawing from library updates library and hand for both players in real time
- Location: e2e\game-draw-library.multiplayer.spec.ts:8:5
