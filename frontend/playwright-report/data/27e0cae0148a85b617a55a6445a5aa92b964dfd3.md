...
- Name: game-drag-drop.multiplayer.spec.ts >> drag and drop moves a card to battlefield and syncs to opponent
- Location: e2e\game-drag-drop.multiplayer.spec.ts:8:5
