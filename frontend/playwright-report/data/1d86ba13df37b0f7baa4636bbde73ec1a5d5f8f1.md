...
- Name: game-life-sync.multiplayer.spec.ts >> life changes are synchronized between two isolated player sessions
- Location: e2e\game-life-sync.multiplayer.spec.ts:9:5
