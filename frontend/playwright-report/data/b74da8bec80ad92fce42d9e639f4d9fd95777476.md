...
- Name: rooms-start-invalid-deck.spec.ts >> room start is blocked when one player deck is Commander-invalid
- Location: e2e\rooms-start-invalid-deck.spec.ts:18:5
