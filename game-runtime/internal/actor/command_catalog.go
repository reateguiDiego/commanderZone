...
var clientInvocableRuntimeCommandTypes = map[string]string{
	...
	"cards.tapped.set":                 "runtime websocket gameplay command",
	"card.face_down.changed":           "runtime websocket gameplay command",
	"cards.face_down.set":              "runtime websocket gameplay command",
	"card.revealed":                    "runtime websocket gameplay command",
	"hand.cards.reveal":                "runtime websocket gameplay command",
	"hand.cards.revoke":                "runtime websocket gameplay command",
	...
	"card.stats.override.set":          "runtime websocket gameplay command",
	"card.stats.override.clear":        "runtime websocket gameplay command",
	...
	"library.selection.move":           "runtime websocket gameplay command",
	"library.top.play_face_down":       "runtime websocket gameplay command",
	"library.shuffle":                  "runtime websocket gameplay command",
	"card.token.created":               "runtime websocket gameplay command",
	"token.group.split":                "runtime websocket gameplay command",
	"token.group.merge":                "runtime websocket gameplay command",
	"token.group.remove_members":       "runtime websocket gameplay command",
	"token.group.dissolve":             "runtime websocket gameplay command",
	"token.group.state.set":            "runtime websocket gameplay command",
	"token.group.position.set":         "runtime websocket gameplay command",
	"token.group.move":                 "runtime websocket gameplay command",
	"token.group.counter.changed":      "runtime websocket gameplay command",
	"token.group.power_toughness.set":  "runtime websocket gameplay command",
	"token.group.controller.changed":   "runtime websocket gameplay command",
	...
	"attachment.reordered":             "runtime websocket gameplay command",
	"battlefield.stack.created":        "runtime websocket gameplay command",
	"battlefield.stack.member_added":   "runtime websocket gameplay command",
	"battlefield.stack.member_removed": "runtime websocket gameplay command",
	"battlefield.stack.reordered":      "runtime websocket gameplay command",
	"battlefield.stack.dissolved":      "runtime websocket gameplay command",
